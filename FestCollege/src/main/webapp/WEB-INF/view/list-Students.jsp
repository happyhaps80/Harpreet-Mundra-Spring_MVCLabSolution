...
<body>
	...
	<div class="container">
		...
		<form action="/FestCollege/students/search" class="form-inline">

			<!-- Add a button -->
			<a href="/FestCollege/students/showFormForAdd"
				...
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							href="/FestCollege/students/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/FestCollege/students/delete?StudentID=${tempStudent.id}"
